...
#ifndef RC_GIMBAL_BRIDGE_RTSP_CAMERA_RELAY_HPP
#define RC_GIMBAL_BRIDGE_RTSP_CAMERA_RELAY_HPP
...
public:
  explicit RoconRtspCameraRelay(ros::NodeHandle &n);
...
private:
  bool tryOpen(const std::string &url, int api_pref);
...
#endif // RC_GIMBAL_BRIDGE_RTSP_CAMERA_RELAY_HPP
